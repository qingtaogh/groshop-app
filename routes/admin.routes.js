...
// route: /admin/profile/:id/update (GET - update profile page)
...
// route: /admin/profile/:id/update (POST - update profile )
router.post("/:id/update", middleware.isLoggedIn, async (req, res) => {
    ...
    .catch(err => {
        ...
        res.redirect(`/admin/profile/${req.user.id}/update`)
    })
});

// route: /admin/profile/:id/changePassword (GET - change password )
...
// route: /admin/profile/:id/changePassword (POST - change password )
